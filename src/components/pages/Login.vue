<template>
  <div class="login">
    ...
    <Modal class="login-modal" v-model="loginModal" width="360" :closable="false" :mask-closable="false">
      <div>
        <h2 style="margin:10px;color:#abcdef;text-align:center">豆壳采购后端管理系统</h2>
      ...
      <div slot="footer">
        ...
        <small style="text-align: center;display:block" class="subText">©copyright by beanshell</small>
      </div>
    </Modal>
  </div>
</template>
